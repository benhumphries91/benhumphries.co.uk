	...
	<div class="container">
		...
		<div class="row timeline">
			<?php 
				...
				$experience_ar[0]['subtitle'] = 'Diploma Mobile App Development';
				...
				$experience_ar[1]['dates'] = '2014 - 2016';
				$experience_ar[1]['title'] = 'Frontend Web Developer';
				// $experience_ar[1]['logo'] = 'src="'.WEB_ROOT.'/lib/img/icons/work.svg" alt="Employment"';

				$experience_ar[2]['subtitle'] = 'Developing Rich Internet Applications';
				...
				$experience_ar[4]['title'] = 'Service Analyst &amp; Web Developer';
				// $experience_ar[4]['logo'] = 'src="'.WEB_ROOT.'/lib/img/icons/work.svg" alt="Employment"';

				$experience_ar[5]['subtitle'] = 'RFA Advertising';
				...
				$experience_ar[5]['title'] = 'Junior Web Developer';
				// $experience_ar[5]['logo'] = 'src="'.WEB_ROOT.'/lib/img/icons/work.svg" alt="Employment"';

				$experience_ar[6]['subtitle'] = 'Bsc Web Design';
				...
				$experience_ar[6]['title'] = 'University Degree';
